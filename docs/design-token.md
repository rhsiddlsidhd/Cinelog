...
The typography uses **DM Sans** (English, numbers) and **PretendardStd** (Korean) — both geometric sans-serif fonts that closely match the visual character of the original CircularSp family. The type system is compact and functional: 700 (bold) for emphasis and navigation, 600 (semibold) for secondary emphasis, and 400 (regular) for body. English buttons use uppercase with positive letter-spacing (1.4px–2px) for a systematic, label-like quality; Korean buttons omit uppercase as it has no visual effect on Hangul.
...
- DM Sans (English/numbers) + PretendardStd (Korean) — geometric sans-serif pair
...
- **Korean (한글 전체)**: `PretendardStd` — variable woff2, weight 100–900
- **English / Numbers**: `DM Sans` — geometric sans-serif, weight 100–700
...
- **Uppercase buttons as system**: English button labels use uppercase + wide letter-spacing (1.4px–2px), creating a systematic "label" voice distinct from content text. Korean button labels omit uppercase — Hangul has no case distinction and the rule has no visual effect.
- **Compact sizing**: The range is 10px–24px — narrower than most systems. The type is compact and functional, designed for scanning, not reading articles.
- **Korean-first fallback**: Pretendard handles all Korean text natively; DM Sans covers English and numeric content. The original global script fallback (Arabic, Hebrew, Cyrillic, CJK) is removed as the target audience is Korean-only.
...
- Dark sidebar with Pretendard / DM Sans 14px weight 700 for active, 400 for inactive
...
- "Create a dark card: #181818 background, 8px radius. Title at 16px Pretendard / DM Sans weight 700, white text. Subtitle at 14px weight 400, #b3b3b3. Shadow rgba(0,0,0,0.3) 0px 8px 8px on hover."
- "Design a pill button: #1f1f1f background, white text, 9999px radius, 8px 16px padding. 14px Pretendard / DM Sans weight 700, uppercase, letter-spacing 1.4px."
